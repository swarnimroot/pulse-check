...
- **Tombstoning policy.** Exact retention window for upstream-deleted mentions and how deletion state is surfaced in the UI (badge wording, whether to exclude tombstoned mentions from new aggregations or include with caveat) — nail down during implementation.
